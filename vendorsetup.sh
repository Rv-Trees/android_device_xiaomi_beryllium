# SDM845 Device
git clone --depth=1 -b serasa-13 https://github.com/Rve27/android_device_xiaomi_sdm845-common.git device/xiaomi/sdm845-common

# Beryllium Vendor
git clone --depth=1 -b serasa-13 https://github.com/Rve27/proprietary_vendor_xiaomi_beryllium.git vendor/xiaomi/beryllium
